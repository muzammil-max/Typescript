...
let getdetails = async () => {
    try {
        let checkdata = await checkstudent("muzammil", 1223); //await tells typescript to wait until a task is completed this is also an asynchronous type
        console.log(checkdata);
        let get = await fetchmarks(true);
        console.log(get);
    }
